function onDisplaySVGLoad(){
    var c = document.getElementById("combo").value
    document.cookie = "SVGObject=" + c + "; path=/"
    ...
    xhr_reqst_svg.onreadystatechange = function(){
        if (this.readyState == 4 && this.status == 200) {
            ...
            xhr.send("");
            //Clear any other content in Element first
    ...
    xhr_reqst_svg.open("POST","/show_control_file_deps",false)
    xhr_reqst_svg.send("");
}
